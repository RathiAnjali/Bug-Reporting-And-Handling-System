...
{
colAccountID.setCellValueFactory(new

PropertyValueFactory<User,Integer>("id"));

colAccountUserName.setCellValueFactory(new PropertyValueFactory<User,

String>("userName"));

colAccountPassword.setCellValueFactory(new PropertyValueFactory<User,

String>("password"));

colAccountIsAdmin.setCellValueFactory(new PropertyValueFactory<User,
...
public void OnBtnUpdateAccountClicked()
{
	...
	boolean isSucceed = model.UpdateAccount(Integer.parseInt(id), userName,

	pwd, isAdd, isDelete, isAdmin);
	...
	{
	colProblemID.setCellValueFactory(new

	PropertyValueFactory<Issue,Integer>("id"));

	colProblemUserID.setCellValueFactory(new PropertyValueFactory<Issue,

	Integer>("userId"));

	colProblemDesc.setCellValueFactory(new PropertyValueFactory<Issue,

	String>("desc"));

	colProblemDate.setCellValueFactory(new PropertyValueFactory<Issue,

	String>("date"));

	colStatus.setCellValueFactory(new PropertyValueFactory<Issue,
	...
	model.UpdateProblem(Integer.parseInt(id),ClientController.userid, description,status,isAdd,
	isDelete);
